...
libname summer 'C:\Users\asv161030\Desktop'; run;
libname utd 'C:\Users\asv161030\Desktop'; run;


proc sort data = utd.logit_data; by custid; run;

proc sort data = utd.logit_demo; by custid; run;

data logit_merge;
merge utd.logit_data utd.logit_demo; 
by custid; run;
